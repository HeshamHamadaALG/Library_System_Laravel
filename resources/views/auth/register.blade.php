                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="phone" type="text" class="form-control{{ $errors->has('phone') ? ' is-invalid' : '' }}" name="phone" value="{{ old('phone') }}" required autocomplete="phone">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="NationalID" type="text" class="form-control{{ $errors->has('NationalID') ? ' is-invalid' : '' }}" name="NationalID" value="{{ old('NationalID') }}" required autocomplete="NationalID">
